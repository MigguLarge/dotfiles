;;; themes/black-and-white-theme.el -*- lexical-binding: t; -*-
;;
...
(def-doom-theme doom-black-and-white
  "A dark theme inspired by VS Code Solarized Dark"

  ;; name        default   256       16
  ((bg         '("#2c2c2c" "#2c2c2c" "brightwhite" ))
   (fg         '("#9d9d9d" "#9d9d9d" "brightwhite" )))

   ;; These are off-color variants of bg/fg, used primarily for `solaire-mode',
   ;; but can also be useful as a basis for subtle highlights (e.g. for hl-line
   ;; or region), especially when paired with the `doom-darken', `doom-lighten',
   ;; and `doom-blend' helper functions.
   (bg-alt     '("#3e3e3e" "#3e3e3e" "white"       ))
   (fg-alt     '("#657b83" "#b1b1b1" "white"       ))

   ;; These should represent a spectrum from bg to fg, where base0 is a starker
   ;; bg and base8 is a starker fg. For example, if bg is light grey and fg is
   ;; dark grey, base0 should be white and base8 should be black.
   (base0      '("#3e3e3e" "#3e3e3e" "black"       ))
   (base1      '("#737373" "#737373" "brightblack" ))
   (base2      '("#8f8f8f" "#8f8f8f" "brightblack" ))
   (base3      '("#9d9d9d" "#9d9d9d" "brightblack" ))
   (base4      '("#a7a7a7" "#a7a7a7" "brightblack" ))
   (base5      '("#a9a9a9" "#a9a9a9" "brightblack" ))
